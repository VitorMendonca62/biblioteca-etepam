...
const preencherFavoritos = () => iconFavoritos.className = "fa fa-heart icon-favoritos";
const desPreencherFavoritos = () => iconFavoritos.className = "fa fa-heart-o icon-favoritos";

const preencherJaLidos = () => iconJaLidos.className = "fa fa-check-square livros-lidos";
const desPreencherJaLidos = () => iconJaLidos.className = "fa fa-check-square-o livros-lidos";

const preencherUsuario = () => iconUsuario.className = "fa fa-user-circle icon-usuario";
const desPreencherUsuario = () => iconUsuario.className = "fa fa-user-circle-o icon-usuario";
